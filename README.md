...
This repository accompanies the paper **“Violations for Continuous Candidates in Constraint-based Phonology”**. It contains the illustrative corpus used by the implementation, the computational script that carries out the analysis, and a graphical interface for interactive use.
